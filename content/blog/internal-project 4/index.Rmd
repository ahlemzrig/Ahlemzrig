---
authors:
- Thanks to Jenny Sloane who wrote this blog please refer to  (https://jennysloane.netlify.app/blog/intro_to_r/)
...
# set_here("C:/Users/jfslo/OneDrive/Main Documents/School/github/jfsloane/content/blog/intro_to_R")
# library(here)
```
...
#medals_raw <- read_csv("content/blog/intro_to_R/data/medals.csv")

medal_standings <- medals_raw %>% 
  clean_names() %>% 
...
medal_standings$medal <- factor(medal_standings$medal, levels = c("gold", "silver", "bronze"), labels = c("Gold", "Silver", "Bronze"))

ggplot(medal_standings, aes(x = reorder(team_noc, total, sum), y = count, fill = medal)) + 
  geom_bar(position = "stack", stat = "identity") +
  coord_flip() + 
  labs(x = "Country", y = "Total Medals") + 
  geom_text(position=position_stack(vjust=0.5), aes(label = count), size=5) +
  theme_bw() + 
